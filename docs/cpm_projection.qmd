...
cpm_tasmax_run_01_path: Final[Path] = plot_folder / "cpm-tasmax-run-1-mean.nc"
cpm_tasmax_run_01_annual_ts: Final[T_Dataset]

if cpm_tasmax_run_01_path.is_file():
    cpm_tasmax_run_01_annual_ts = open_dataset(cpm_tasmax_run_01_path)
else:
...
leap_annual_means: T_Dataset = cpm_annual_ts.where(cpm_annual_ts.time.dt.year % 4 == 0)
