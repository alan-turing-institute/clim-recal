...
Below are shell commands that can be passed to the command-line to download subsets of the data as required having first downloaded the [full list of file URLs](urls/data-v1.0.txt) (`data-v1.0.txt`).
