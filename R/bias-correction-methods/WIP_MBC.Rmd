...
i2 <- rast()
crs(i2) <- crs(Hads_r_eg)
ext(i2) <- c(300000, 350000, 250000, 300000)
ext2 <- as.polygons(ext(i2))
...
#save.image("~/Desktop/clim-recal/clim-recal/data/MBCdata/MBCimage.1.RData") 
...
hist.years <- paste0(1980:1999, "1201", collapse="|") #Historical years 
...
#HERE
Load later and infill CPM data
