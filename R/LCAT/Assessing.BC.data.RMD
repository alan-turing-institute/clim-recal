...
#Extract validation period of raw and bias corrected CPM data -- need to update the 1 
val.dfs <- lapply(London.dfg.rL, function(x))
 London.df <- London.dfg.rL
  cpm.val.dfs <- lapply(London.df[[1]][c("t.proj", "qm1.proj.a", "qm1.proj.b")], function(x){
...
**to do** I think also extracting and aligning a similar cal.dfs would really help here  
...
I used 100 quantiles but obviously more within qmap would help! 
