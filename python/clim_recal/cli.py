...
def pipeline(
    ...
    cpm_projection: Annotated[bool, typer.Option(" /--skip-cpm")] = True,
    hads_projection: Annotated[bool, typer.Option(" /--skip-hads")] = True,
    crop_hads: Annotated[bool, typer.Option(" /--skip-crop-cpm")] = True,
    crop_cpm: Annotated[bool, typer.Option(" /--skip-crop-hads")] = True,
