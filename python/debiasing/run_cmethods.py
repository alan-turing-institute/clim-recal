...
h_date_period = ('1981-01-01', '1983-01-01')
f_date_period = ('2020-01-01', '2030-01-01')
...
def main() -> None:
    ...
    ds_simp = load_data(contr_fpath, date_range=f_date_period, variable=var, shapefile_path=shape_fpath, extension='tif')[var].rename({"projection_x_coordinate": "lon", "projection_y_coordinate": "lat"})
